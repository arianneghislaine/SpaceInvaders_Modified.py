...
#Culminating
#ICS2O1
#The culminating is consisting of two parts App project and Written evaluation.
#This assignment must be done individually.  
#Use Microsoft word to write the guideline of your application.
#Use Python programing to write an application program with a entertainment and/or educational purposes.
#Note that:
#Ø  Previously submitted assignment CANNOT be resubmitted
#Ø  Comments must be used to describe the codes and algorithms
#Ø  The application must demonstrate knowledge of the topics learned in class
#Ø  Use comments to explain the function of the code it in detail when using codes learned on your own

#The application may include some or all of the following:
#·  The application must have a defined purpose.
#·  Entertaining
#·  Logical Game of reasoning
#·  Educational
#·  Random variables
#·  Enhance memory

#Marking scheme is as follows:
#1.  	Proper setting of program with comments to explain the codes and algorithms                                                                              	(10 marks)
#2.  	Manipulation of the code------------------------------------------(10 marks)
#3.  	Presentation June 11th--------------------------------------------(10 marks)
#4.  	The logic and appeal of the application---------------------------(20 marks)
#5.  	Written evaluation  June 10th-------------------------------------(40 marks)
